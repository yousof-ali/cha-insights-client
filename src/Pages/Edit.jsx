...
const Edit = () => {
  ...
  const { _id, name, chef, taste, price, photo, category, details } =
    singleData;
  ...
  return (
    <div className="px-2 md:px-4 bg-base-200 py-6 md:py-12">
      <Link to={"/"}>
        <Commonbutton>Back to Home</Commonbutton>
      </Link>
      <div className="max-w-[900px] mt-4 mx-auto  shadow-lg rounded-xl bg-orange-50  p-8">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-extrabold">Edit CHA</h2>
          <p className="font-light">Edit a new cha for cha lovers..</p>
        </div>
        <form onSubmit={handleUpdate}>
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="space-y-2 ">
                ...
                <input
                  ...
                  required
                  placeholder="Details"
                  defaultValue={singleData?.details}
                  className="p-2 rounded-xl outline-orange-300 w-full"
                />
              </div>
            </div>
          ...
          <div className="flex justify-center">
            <input
              className="border-2 font-bold text-white border-orange-200 bg-orange-700 hover:bg-[#ffffff00] rounded-xl hover:text-orange-200 hover:border-orange-700 p-2"
              type="submit"
              value={"Update"}
            />
          </div>
